...
public class Ellipse implements Shape {
	private String id; // Used for distinguishing shapes that appear across clients
	...
	/**
	 * Encodes Ellipse instance as String so that it can be transmitted through server/client interactions
	 * @return
	 */
	@Override
	public String toString() {
		if (this.id == null){
			...
			return "ellipse "+x1+" "+y1+" "+x2+" "+y2+" "+color.getRGB()+" "+this.getID();
		}
	}
